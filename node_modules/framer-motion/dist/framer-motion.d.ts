 ...
 * @internal
 */
export declare type CustomDomComponent<Props> = React_2.ForwardRefExoticComponent<React_2.PropsWithoutRef<Props & MotionProps> & React_2.RefAttributes<SVGElement | HTMLElement>>;
 ...
 * @public
 */
export declare const m: (<Props>(Component: string | import("react").ComponentClass<Props, any> | import("react").FunctionComponent<Props>, { forwardMotionProps }?: import("./motion-proxy").DomMotionComponentConfig) => import("./motion-proxy").CustomDomComponent<Props>) & import("./types").HTMLMotionComponents & import("./types").SVGMotionComponents & {
